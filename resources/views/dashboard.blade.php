    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                ...
                <div class="bg-blue-100 dark:bg-blue-900 p-3 rounded-full" style="background-color: #dbeafe !important;">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-500 dark:text-blue-300"
                        fill="none" viewBox="0 0 24 24" stroke="currentColor" style="color: #2563eb !important;">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
